...
namespace Sara_UI_Design.SaraControls {
    ...
    public class CircularProgressBar:ProgressBar {
        ...
        protected virtual void InitializeContinues(bool firstTime) {
            ...
            _animator.Paths =
                new WinFormAnimation.Path(_animatedValue ?? Value, Value, (ulong) AnimationSpeed, CustomAnimationFunction).ToArray();
        ...
        protected virtual void InitializeMarquee(bool firstTime) {
            ...
            _animator.Paths = new WinFormAnimation.Path(0, 359, (ulong) MarqueeAnimationSpeed, CustomAnimationFunction).ToArray();
